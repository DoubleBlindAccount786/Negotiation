% Pr
sale(Product, Maker, Price) :- Product = a, offer_price_a(Product, Maker, Price), not asked(buy(Product, Maker, Price)), not asked(-buy(Product, Maker, Price)). 
sale(Product, Maker, Price) :- Product = b, offer_price_b(Product, Maker, Price), not asked(buy(Product, Maker, Price)), not asked(-buy(Product, Maker, Price)). 
